...
export default function Chat() {
  const { messages, input, isLoading, handleInputChange, handleSubmit, setInput } = useChat({ api: "/api/pronunciation" });
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-between">
      <div className="fixed right-8 top-20 rounded-md bg-fuchsia-600 p-4 text-white">발음 평가 챗봇</div>
